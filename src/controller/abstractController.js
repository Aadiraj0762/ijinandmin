...
//       authors: abstractData.authors || [{ name: '', affiliation: '' }], // Handle authors array
...
//     const {
//       journalName, issn, publisher, title, authors, abstract, linkDOI, articleType, assetFile
//     } = docSnap.data();
...
export const createAbstract = async (abstractData) => {
  try {
    const completeAbstractData = {
      ...
      publisher: abstractData.publisher || '',
      title: abstractData.title || '',
      authors: abstractData.authors || [], // Array of authors
      abstract: abstractData.abstract || '',
      keyword: abstractData.keyword || '',
      linkDOI: abstractData.linkDOI || '',
      articleType: abstractData.articleType || '',
      year: abstractData.year || '',
      volumeIssue: abstractData.volumeIssue || '',
      pageNumber: abstractData.pageNumber || '',
    };
...
export const getAbstractById = async (id) => {
  try {
    ...
    const {
      journalName, issn, publisher, title, authors, abstract, keyword, linkDOI, articleType, year, volumeIssue, pageNumber, assetFile
    } = docSnap.data();
